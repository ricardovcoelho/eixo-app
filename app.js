...
function renderRoutines(){
  ...
  el.querySelectorAll('.add-r').forEach(function(b){b.addEventListener('click',function(){populateRCatOptions();document.getElementById('r-cat').value=b.dataset.cat;document.getElementById('routine-modal-title').textContent='Nova Rotina';editRoutineId=null;document.getElementById('r-name').value='';document.getElementById('r-freq').value='daily';openModal('modal-routine');});});
